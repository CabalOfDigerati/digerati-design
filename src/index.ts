 ...
 */
barba.hooks.enter(() => {
  console.log('BEFORE Reset Scroll');
  window.scrollTo(0, 0);
  console.log('AFTER Reset Scroll');
});
barba.hooks.after(() => {
  console.log('BEFORE Restart Webflow');
  console.log('BEFORE Click Star');
  console.log('AFTER Click Star');
  restartWebflow();
  initialiseHomepage();
  console.log('AFTER Restart Webflow');
});
barba.init({
  preventRunning: true,
  transitions: [
...
const initialiseHomepage = () => {
  console.log('BEFORE Typed.js Init');
  const heroBannerHeading = document.getElementById('hero-banner-heading');
  const allSeeingEyeStar = document.getElementById('all-seeing-eye-star');
  allSeeingEyeStar.click();
  if (heroBannerHeading) {
    console.log('Hero Banner Heading exists.');
    new Typed(heroBannerHeading, {
      strings: [
        '<span class="home_hero-banner_heading-highlight">No-Code</span>',
        '<span class="home_hero-banner_heading-highlight">Low-Code</span>',
        '<span class="home_hero-banner_heading-highlight">Yes-Code</span>'
      ],
      typeSpeed: 100,
      backSpeed: 50,
      backDelay: 2500,
...
/**
 * Initialise Lava Lamp.
 */
const initialiseLavaLamp = () => {
  ...
  const makeRandomPalette = () => {
    ...
    */
    /*
    const c1 = { r: 99, g: 35, b: 210 }; // Purple
    const c2 = { r: 74, g: 74, b: 255 }; // Blue
    const c3 = { r: 255, g: 102, b: 204 }; // Pimk
    const c4 = { r: 204, g: 255, b: 102 }; // Lime
    const c5 = { r: 102, g: 255, b: 204 }; // Mint
    */
    const c1 = { r: 99, g: 35, b: 210 }; // Purple
    const c3 = { r: 74, g: 74, b: 255 }; // Blue
    const c2 = { r: 99, g: 35, b: 210 }; // Purple
    const c4 = { r: 74, g: 74, b: 255 }; // Blue
    const c5 = { r: 204, g: 255, b: 102 }; // Lime
